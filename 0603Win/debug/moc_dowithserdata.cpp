...
**
** Created: Tue Jun 4 10:12:55 2013
...
void DoWithSerData::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData DoWithSerData::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject DoWithSerData::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_DoWithSerData,
      qt_meta_data_DoWithSerData, &staticMetaObjectExtraData }
};
